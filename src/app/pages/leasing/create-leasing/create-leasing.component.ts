...
export class CreateLeasingComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.initialInput = this.formBuilder.group({
      ...
      initialFee: [0, [Validators.required, Validators.min(0)]],
      ...
      studyComission: [[0, Validators.required, Validators.min(0)]],
      activationComission: [[0, Validators.required, Validators.min(0)]],
